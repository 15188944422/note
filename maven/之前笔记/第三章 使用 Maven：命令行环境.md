...
D:\Power\Maven\MavenTest\pro-maven-java\target\pro-maven-java-1.0-SNAPSHOT.jar

groupId:pro-maven-java
...
​	import com.songsir.maven.Calculator;
...
在父工程中修改依赖的版本号,子工程所用父工程的依赖 就会发生改变
```
