...
![](springimg\ApplicationContext的主要实现类.png)
...
即通过bean的类型，bean所继承的类的类型,bean所实现接口的类型都可以获取bean对象
...
####  ①介绍
 ...
 可以通过@Transactional中相关属性设置回滚策略,默认开启的是rollbackFor回滚的 
