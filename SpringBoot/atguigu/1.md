...
@SpringBootApplication //等同于下面的三个
//@SpringBootConfiguration
//@EnableAutoConfiguration
//@Configuration("com.song.boot")
public class MainApplication {
    public static void main(String[] args) {
        //1.返回ioc容器
        ConfigurableApplicationContext run = SpringApplication.run(MainApplication.class, args);
        ...
        //com.song.boot.config.MyConfig$$EnhancerBySpringCGLIB$$76a034b6@732bb66d
        ...
        //保持组件单实例,如果有就不会新创
        Pet tomcat = bean.tomcat();
        User user = bean.User01();

        System.out.println(user==user01);//true
        System.out.println(tomcat==pet);//true

        User user011 = run.getBean("User01", User.class);
        Pet tom=run.getBean("tom",Pet.class);
        System.out.println("用户的宠物:"+(user011.getPet()==tom));//true
